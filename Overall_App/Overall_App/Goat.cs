...
namespace Overall_App
{
    internal class Goat: Animal
    {
        ...
        public Goat(int id, double water, double cost, double weight, int age, string color, double milk) : base(id, water, cost, weight, age, color) //id is inherited from Animal class
        {
            this.milk = milk; //constructor
        }
        ...
        {
            double total = milk * Rates_Prices.goatMilkPrice - cost;
            return total;
        }
